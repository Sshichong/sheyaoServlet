...
/**
 * Servlet implementation class yijiaservlet
 */
@WebServlet("/yijiaservlet")
public class yijiaservlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//获取查询值
				...
				//处理数据
						...
						yijia = dataProcess.getData("select * from doctor where Doctor_name like '%"+select_name+"%' or Doctor_forSelect like '%"+select_name+"%'");
